...
namespace SnakeGameProject
{
    public class GameForm : Form
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            // BLACK BORDER
            g.DrawRectangle(new Pen(Color.Black, 4), 0, 0,
                controller.Board.Width * cellSize - 1,
                controller.Board.Height * cellSize - 1);
            ...
            g.DrawString(
                ...
                "   Level: " + controller.LevelManager.CurrentLevel.LevelName,
                new Font("Arial", 12),
                Brushes.Black,
                10,
                520
